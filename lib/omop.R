...
omop_render_data_tables <- function(input, output, cfg) {
  ...
  output$condition_era_tbl <- DT::renderDataTable(condition_era_data(), options = list(paging = FALSE, searchHighlight = TRUE, scrollX = TRUE, scrollY = TRUE), rownames=F, selection='none')
  output$condition_occurrence_tbl <- DT::renderDataTable(condition_occurrence_data(), options = list(paging = FALSE, searchHighlight = TRUE, scrollX = TRUE, scrollY = TRUE), rownames=F, selection='none')
  output$death_tbl <- DT::renderDataTable(death_data(), options = list(paging = FALSE, searchHighlight = TRUE, scrollX = TRUE, scrollY = TRUE), rownames=F, selection='none')
  output$device_exposure_tbl <- DT::renderDataTable(device_exposure_data(), options = list(paging = FALSE, searchHighlight = TRUE, scrollX = TRUE, scrollY = TRUE), rownames=F, selection='none')
  output$dose_era_tbl <- DT::renderDataTable(dose_era_data(), options = list(paging = FALSE, searchHighlight = TRUE, scrollX = TRUE, scrollY = TRUE), rownames=F, selection='none')
  output$drug_era_tbl <- DT::renderDataTable(drug_era_data(), options = list(paging = FALSE, searchHighlight = TRUE, scrollX = TRUE, scrollY = TRUE), rownames=F, selection='none')
  output$drug_exposure_tbl <- DT::renderDataTable(drug_exposure_data(), options = list(paging = FALSE, searchHighlight = TRUE, scrollX = TRUE, scrollY = TRUE), rownames=F, selection='none')
  output$measurement_tbl <- DT::renderDataTable(measurement_data(), options = list(paging = FALSE, searchHighlight = TRUE, scrollX = TRUE, scrollY = TRUE), rownames=F, selection='none')
  output$note_tbl <- DT::renderDataTable(note_data(), options = list(paging = FALSE, searchHighlight = TRUE, scrollX = TRUE, scrollY = TRUE), rownames=F, selection='none')
  ...
  output$observation_tbl <- DT::renderDataTable(observation_data(), options = list(paging = FALSE, searchHighlight = TRUE, scrollX = TRUE, scrollY = TRUE), rownames=F, selection='none')
  output$observation_period_tbl <- DT::renderDataTable(observation_period_data(), options = list(paging = FALSE, searchHighlight = TRUE, scrollX = TRUE, scrollY = TRUE), rownames=F, selection='none')
  output$payer_plan_period_tbl <- DT::renderDataTable(payer_plan_period_data(), options = list(paging = FALSE, searchHighlight = TRUE, scrollX = TRUE, scrollY = TRUE), rownames=F, selection='none')
  output$person_tbl <- DT::renderDataTable(person_data(), options = list(paging = FALSE, searchHighlight = TRUE, scrollX = TRUE, scrollY = TRUE), rownames=F, selection='none')
  output$procedure_occurrence_tbl <- DT::renderDataTable(procedure_occurrence_data(), options = list(paging = FALSE, searchHighlight = TRUE, scrollX = TRUE, scrollY = TRUE), rownames=F, selection='none')
  output$specimen_tbl <- DT::renderDataTable(specimen_data(), options = list(paging = FALSE, searchHighlight = TRUE, scrollX = TRUE, scrollY = TRUE), rownames=F, selection='none')
  output$visit_occurrence_tbl <- DT::renderDataTable(visit_occurrence_data(), options = list(paging = FALSE, searchHighlight = TRUE, scrollX = TRUE, scrollY = TRUE), rownames=F, selection='none')
  output
}
