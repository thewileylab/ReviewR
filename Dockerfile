...
RUN Rscript -e 'remotes::install_version("shinyBigQuery",upgrade="never", version = "0.0.2.9002")'
...
RUN Rscript -e 'remotes::install_github("thewileylab/synPUF@49d915a8bb821e4b0de442aaa00d0226adb2babc")'
RUN Rscript -e 'remotes::install_github("thewileylab/shinyREDCap@927b5947abe8a10dd73afd9ea5c42ec5e33713c9")'
