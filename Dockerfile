...
RUN Rscript -e 'remotes::install_version("gt",upgrade="never", version = "0.5.0")'
...
RUN Rscript -e 'remotes::install_version("REDCapR",upgrade="never", version = "1.0.0")'
...
RUN Rscript -e 'remotes::install_version("bigrquery",upgrade="never", version = "1.4.0")'
