...
RUN Rscript -e 'remotes::install_version("rstudioapi",upgrade="never", version = "0.11")'
...
RUN Rscript -e 'remotes::install_github("thewileylab/shinyREDCap@0be1ae51099f17442f9d87d19280b1f1c72dd4f2")'
RUN Rscript -e 'remotes::install_github("thewileylab/shinyBigQuery@1b6419cc2b874b89b1451b3274c2f72b3f957822")'
