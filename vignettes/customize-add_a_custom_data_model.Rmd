...
Additionally, the "all paients" table function must be designed to accept two arguments from ReviewR:

* `table_map`: returned by the datamodel detecion module, 
...
These table functions must also be designed to accept 3 arguments
