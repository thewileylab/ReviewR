...
```
A dataframe with 4 columns will be returned, indicating the file path[*](#file-path) of the data source, the data model name, the data model version, and data column containing a nested dataframe with the schema of the data model itself. 
