...
Once the required database credentials have been provided, the database setup module will create a connection to your database and attempt to identify the data model of the patient data contained within. 
...
ReviewR is now ready for you to view the patient information contained within your database. If you would like to configure chart abstraction, please see the vignette on connecting to a REDCap project:

* `vignette('connect_to_redcap')`

Otherwise, head to the 'Patient Search' page located in the left navigation bar to choose a patient. Click the patient's subject ID to be taken to the Chart Review section of ReviewR to view individual patient level records. 
