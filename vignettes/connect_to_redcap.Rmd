...
Once you have set up your REDCap project as defined above, you are ready to connect to it from ReviewR. Load ReviewR either by visiting your institution's deployed URL, or by running `ReviewR::run_app()`. Head to the setup tab and connect to your patient data, using the 'Connect to Patient Database' pane. 
...
```
After entering this information, click the 'Connect to REDCap' button. Note that the connect button will only appear after both a URL and API key are supplied. 
