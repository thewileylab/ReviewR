...
ReviewR has developed a way to interactively switch between database modules that have been developed for the package. These modules consist of a UI to guide the user through establishing a database connecton and a server responsible for validating user inputs, establishing a connection, and returning a DBI connection objects. Users can extend the functionality of ReviewR by adding developed database modules to `R/mod_database_setup.R` as shown below:
