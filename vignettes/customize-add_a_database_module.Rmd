...
As you are developing/testing, remember to add your completed `setup_server` function to `R/mod_database_setup.R` in order to have the module display within ReviewR. When incorporated into ReviewR, the `moduleName` portion of the database module's reactiveValues return will be what shows up in the Database Module Selector drop down list. When you are ready to test, run:
