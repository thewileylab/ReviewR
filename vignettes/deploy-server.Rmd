...
In the sections that follow, it is assumed that the user has already deployed and secured an [Open Source Shiny Server](https://rstudio.com/products/shiny/download-server/) with a stable https URL. Shiny Server deployment/configuration is outside the scope of this document, however instructions on how to set up and secure your installation can be found in the <a href="#prerequisites">Prerequisites</a> section below.
...
1. Install the ReviewR package as a root user, to ensure your system R package library has all of the required dependencies
